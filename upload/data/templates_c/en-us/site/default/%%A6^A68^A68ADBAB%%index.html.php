...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ads', 'default\\index.html', 11, false),array('block', 'announce', 'default\\index.html', 23, false),array('block', 'fair', 'default\\index.html', 72, false),array('block', 'offer', 'default\\index.html', 92, false),array('block', 'company', 'default\\index.html', 130, false),array('block', 'tag', 'default\\index.html', 148, false),array('block', 'brand', 'default\\index.html', 186, false),array('block', 'news', 'default\\index.html', 235, false),array('block', 'product', 'default\\index.html', 272, false),array('block', 'newstype', 'default\\index.html', 290, false),array('block', 'topic', 'default\\index.html', 350, false),array('block', 'friendlink', 'default\\index.html', 374, false),array('function', 'get', 'default\\index.html', 151, false),array('function', 'the_url', 'default\\index.html', 154, false),array('function', 'formhash', 'default\\index.html', 253, false),array('function', 'the_attachment', 'default\\index.html', 352, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['_free_reg_member']; ?>
	...
	<div class="content clearfix">
		<div class="fl notebox mr7">
                ...
                <h2><span class="title_more"><a href="index.php?do=fair&action=lists" title="<?php echo $this->_tpl_vars['_more']; ?>
"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
		...
		<div class="fl latest">
            ...
            <ul class="tabs2 title_mouse">
                  <li><a href="index.php?do=offer&action=lists&typeid=2"><span><?php echo $this->_tpl_vars['_newest_sell']; ?>
</span></a></li>
                  <li><a href="index.php?do=offer&action=lists&typeid=1"><span><?php echo $this->_tpl_vars['_newest_buy']; ?>
</span></a></li>
            </ul>
...
?>
			  <div class="typebox clearfix bg_hover">
                <div class="category_title category_title_width"><a href="<?php echo smarty_function_the_url(array('module' => 'search','action' => 'lists','industryid' => ($this->_tpl_vars['item0']['id']),'do' => 'product'), $this);?>
...
?>
						<li>
							<a href="<?php echo smarty_function_the_url(array('module' => 'search','industryid' => ($this->_tpl_vars['level1']['id']),'do' => 'product','action' => 'lists'), $this);?>
...
?>
							<a href="<?php echo smarty_function_the_url(array('module' => 'search','industryid' => ($this->_tpl_vars['level2']['id']),'do' => 'product','action' => 'lists'), $this);?>
...
" /></a><p><?php echo $this->_tpl_vars['item']['title']; ?>
			...
			<div class="fl notebox">
				<div class="title_bar_s1">
                <span class="title_top_s1"><span></span></span>
                <h2><span class="title_more"><a href="index.php?do=offer&action=lists&typeid=3" title="<?php echo $this->_tpl_vars['_more']; ?>
"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
			...
			<div class="fl notebox">
				 <div class="title_bar_s1">
                <span class="title_top_s1"><span></span></span>
                <h2><span class="title_more"><a href="index.php?do=offer&action=lists&typeid=5" title="<?php echo $this->_tpl_vars['_more']; ?>
"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
...
"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
			...
			<div class="fl notebox">
				...
				<div class="hotcont_service">
					...
					<form action="index.php?do=service&action=post" name="service_frm" id="ServiceFrm" method="post">
...
"><span><?php echo $this->_tpl_vars['newstype']['title']; ?>
			...
			<div class="fl latest02">
				<div class="title_bar_s1">
                <span class="title_top_s1"><span></span></span>
                <h2><span class="title_more"><a href="<?php echo smarty_function_the_url(array('module' => 'search','do' => 'news','type' => 'hot','action' => 'lists'), $this);?>
" title="<?php echo $this->_tpl_vars['_more']; ?>
"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
...
" /></a>
			...
			<div class="fr hotzt">
				<div class="hotztbox">
                   <div class="title">
					<span class="more"><a href="index.php?do=topic&action=lists"><span class="raquo">&raquo;</span><?php echo $this->_tpl_vars['_more']; ?>
...
" title=""><?php echo smarty_function_the_attachment(array('name' => ($this->_tpl_vars['item']['picture']),'type' => 'small'), $this);?>
	...
	<div class="content">
		<div class="pardent">
			<p><a href="index.php?do=friendlink" title="<?php echo $this->_tpl_vars['_apply_friendlink']; ?>
