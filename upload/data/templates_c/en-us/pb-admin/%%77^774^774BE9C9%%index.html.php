...
js/index.js" charset="<?php echo $this->_tpl_vars['charset']; ?>
"></script>
<div class="back_nav">
...
');none_fn();"><?php echo $this->_tpl_vars['sub_menu']['text']; ?>
    ...
    <div class="close_float"><img src="<?php echo $this->_tpl_vars['admin_theme_path']; ?>
images/close2.gif" /></div>
</div>
<div id="head">
    <div id="logo"><img src="<?php echo $this->_tpl_vars['admin_theme_path']; ?>
images/phpb2b_logo.png" /></div>
...
<div id="content">
 ...
 <?php echo @PHPB2B_VERSION; ?>
			...
			<p>&copy; 2007-2012 <a href="http://www.phpb2b.com/" target="_blank">UALINK</a> Inc.</p>
		</div>
    </div>
    <div id="right">
