<?php /* Smarty version 2.6.27, created on 2013-02-23 12:22:29
         compiled from login.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'sprintf', 'login.html', 5, false),array('function', 'formhash', 'login.html', 27, false),array('function', 'get_cache', 'login.html', 35, false),)), $this); ?>
...
<title><?php echo ((is_array($_tmp=$this->_tpl_vars['_control_login'])) ? $this->_run_mod_handler('sprintf', true, $_tmp, $this->_tpl_vars['_control_pannel']) : sprintf($_tmp, $this->_tpl_vars['_control_pannel'])); ?>
 - <?php echo $this->_tpl_vars['_G']['site_title']; ?>
</title>
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['admin_theme_path']; ?>
css/login.css" />
...
getpasswd.php"><?php echo $this->_tpl_vars['_cp_forget_passwd']; ?>
		   ...
		   <?php echo smarty_function_get_cache(array('name' => 'language','var' => 'lan'), $this);?>

		   <?php if ($this->_tpl_vars['lan']): ?>
		   <div class="user"><label><?php echo $this->_tpl_vars['_lang_pack']; ?>
<?php echo $this->_tpl_vars['_colon']; ?>
</label>
			   <select name="data[language]" id="dataLanguage">
			   <?php $_from = $this->_tpl_vars['lan']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
				<option value="<?php echo $this->_tpl_vars['key']; ?>
" <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['AppLanguage']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['item']['title']; ?>
</option>
			   <?php endforeach; endif; unset($_from); ?>
				<option value=""><?php echo $this->_tpl_vars['_please_select']; ?>
</option>
			   </select>
		   </div>
		   <?php endif; ?>
