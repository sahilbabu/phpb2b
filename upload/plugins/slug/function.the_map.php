...
<script type="text/javascript" src="'.URL.'scripts/googlemap_init.js"></script>
...
$op.='<input type="hidden" name="mapaddress" id="address" value="'.$longti.','.$lati.'"/>';
$op.='<DIV id="mainmap" style="width:'.$width.';height:'.$height.';border:1px solid #000;"></DIV>';
	return $op;
}
?>