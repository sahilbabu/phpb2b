...
$dbpasswd = 'root';					// database user password
$dbname = 'phpb2b_db';				// database user
$pconnect = 0;							// if database long connect

/**
 * set cookie
 */
$cookiepre = 'YAu_';					// cookie prefix
 ...
 */
$admin_email = 'sahil_bwp@yahoo.com';
$administrator_id = '1';

/**
 * domain and url config
 */
$absolute_uri = 'http://phpb2b-local:8080/';
