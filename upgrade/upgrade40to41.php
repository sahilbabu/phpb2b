...
define('PHPB2B_ROOT', dirname(__FILE__)."/");
...
$low_version  = array("4.0.5","4.0.4","4.0.3","4.0.2","4.0.1","4.0.0");
...
<?php
$alter_tb[5] = <<<EOT
ALTER TABLE `pb_jobs` ADD `jobtype_id` SMALLINT( 6 ) NOT NULL DEFAULT '0';
EOT;
$alter_tb[4] = <<<EOT
ALTER TABLE `pb_jobs` ADD `jobtype_id` SMALLINT( 6 ) NOT NULL DEFAULT '0';
EOT;
...
EOT;
$alter_public = <<<EOT
ALTER TABLE `pb_newses` ADD `start_time` DATE NOT NULL ,
ADD `end_time` DATE NOT NULL;
ALTER TABLE `pb_spreads` ADD `show_times` INT( 10 ) NOT NULL DEFAULT '1',
ADD `cost_every_hit` FLOAT( 7, 2 ) NOT NULL DEFAULT '0';
